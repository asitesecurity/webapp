   ...
   stage ('Source Composition Analysis') {
      steps {
       ...
       //  sh 'sshpass -p "toor" ssh root@192.168.100.131 "pwd"'
         sh 'sshpass -p "kali" ssh kali@192.168.100.131 "echo "kali" | sudo chmod +x owasp-dependency-check.sh" '
         sh 'sshpass -p "kali" ssh kali@192.168.100.131 "echo "kali" | sudo bash owasp-dependency-check.sh" '
